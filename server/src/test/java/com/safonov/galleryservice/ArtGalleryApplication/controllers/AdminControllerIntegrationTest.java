...
public class AdminControllerIntegrationTest {
    ...
    @Test
    public void getRolesWithCode200() throws Exception {
        ...
        final ResponseEntity<Object> result1 = testRestTemplate.exchange("/api/roles", HttpMethod.GET, new HttpEntity<>(headers), Object.class);
