...
public interface GalleryFacade {
    ...
    Payment getPayment(final long payment);
    ClientOwnerPayment getClientOwnerPayment(final long payment);
    OwnerArtistPayment getOwnerArtistPayment(final long payment);
    ...
    void createExpo(@NotNull final String owner,
                    @NotNull final String name,
